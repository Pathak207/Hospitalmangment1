            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {subscriptionPlans.map((plan, index) => (
                <div key={plan._id} className={`relative bg-white dark:bg-gray-800 rounded-3xl shadow-xl border-2 p-8 transition-all duration-300 hover:scale-105 ${
                  ...
                  <div className="mt-8">
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-6">What's included:</h4>
                    <ul className="space-y-4">
                      ...
                      <li className="flex items-center">
                        <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                        <span className="text-gray-600 dark:text-gray-300">HIPAA compliance</span>
                      </li>
                      <li className="flex items-center">
                        <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {landingContent.testimonials.items.map((testimonial, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
                ...
                <div className="flex items-center">
                  <div className="w-14 h-14 bg-gradient-to-br from-purple-400 to-blue-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-6">
                ...
                <span className="ml-3 text-xl font-bold text-white">DoctorCare</span>
              </div>
              <p className="text-gray-400 leading-relaxed">
                Modern practice management made simple for healthcare providers.
              </p>
            </div>
            <div>
