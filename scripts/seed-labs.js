...
const LabResult = require('../models/LabResult.js').default;
const Patient = require('../models/Patient.js').default;
...
async function seedLabs() {
  try {
    // Connect to MongoDB
    await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/doctroe-care');
